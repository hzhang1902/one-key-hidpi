...
```bash
ls /Volumes/
cd /Volumes/"Your System Disk Part"/Library/Displays/Contents/Resources/Overrides/HIDPI
...
Remove your display's DisplayVendorID folder under `/Library/Displays/Contents/Resources/Overrides` , and move backup files
...
```bash
ls /Volumes/
cd /Volumes/"Your System Disk Part"/Library/Displays/Contents/Resources/Overrides
